...
import com.margarin.onlineshopeffectivetestwork.presentation.createStringAvailableForOrder
import com.margarin.onlineshopeffectivetestwork.presentation.createStringCountOfFeedback
import com.margarin.onlineshopeffectivetestwork.presentation.details.adapter.DetailsAdapter
    ...
    private fun setOnClickListeners() {
        with(binding) {
            ...
            bLike.setOnClickListener {
                product?.let { viewModel.sendEvent(DetailsEvent.ChangeFavouriteStatus(it)) }
            }
